...
from eve.utils.logging_setup import setup_log_listener, install_log_queue_handler
from eve.app.scheduler import run_scheduler
from eve.config.settings import settings

def parse_args():
  p = argparse.ArgumentParser(prog='eve', description='Speech-only generator scheduler')
...
def main():
  ...
  try:
    ...
    logging.getLogger('eve.bootstrap').info('eve starting...')
